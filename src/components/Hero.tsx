  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center py-20 px-4 relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-20 left-10 w-72 h-72 bg-accent/20 rounded-full filter blur-3xl opacity-20 animate-float" />
      ...
      <div className="max-w-4xl w-full text-center">
        ...
        <h1
          className="animate-slide-up text-4xl md:text-6xl font-black text-white mb-6 leading-tight"
        ...
        <p
          className="animate-slide-up text-xl md:text-2xl font-bold text-accent mb-4"
        ...
        <p
          className="animate-slide-up text-white/70 text-base md:text-lg max-w-2xl mx-auto mb-12"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-16">
          {metrics.map((metric, idx) => (
            <div
              key={metric.label}
              className="animate-slide-up p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/30 hover:bg-white/10 hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 group cursor-pointer"
        ...
        {/* CTA Buttons */}
        <div
          className="animate-slide-up flex gap-4 justify-center flex-wrap"
